...
az acr repository list --name <acrName> --output table
  ...
  ###### obtiene el ACR asociado al grupo de recursos
  
  
  az acr list --resource-group RG_automotriz --query "[].{acrLoginServer:loginServer}" --output table
  
  
  ###### obtiene las versiones publicadas para la imagen
  
  az acr repository show-tags --name <acrName> --repository <image name> --output table
